...
- The daemon's launchd agent registers at daemonkit's version-stable program
  path (`~/.daemonkit/bin/cc-present`); daemonkit v0.20.1 heals stored
...
### Changed
- Pin daemonkit v0.19.1 and Synckit v0.35.2 so terminal worker claims tear
  down the daemon runtime throughout the service and trust-verifier graph.
...
### Changed
- Repin daemonkit v0.16.0 for the exact installed-runtime activation contract.
...
[0.15.0]: https://github.com/yasyf/cc-present/compare/v0.14.2...v0.15.0
[0.14.2]: https://github.com/yasyf/cc-present/compare/v0.14.1...v0.14.2
